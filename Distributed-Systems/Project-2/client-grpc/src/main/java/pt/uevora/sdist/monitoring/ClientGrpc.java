...
import pt.uevora.sdist.monitoring.grpcmanager.GrpcClientSimulator;
...
public class ClientGrpc {
    ...
    /**
     * Prints the menu options for the gRPC client.
     */
    ...
    public static void main(String[] args) {
        GrpcClientSimulator simulator = null;

        Boolean running = true;

        try (BufferedReader reader = new BufferedReader(new InputStreamReader(System.in))) {
            simulator = new GrpcClientSimulator();
            while (running) {
                printMenu();
